...
mistserver:
	...
	&& cd ./build/mistserver \
	&& cmake ../../../mistserver -DPERPETUAL=1 -DLOAD_BALANCE=1 -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX} -DCMAKE_PREFIX_PATH=$(buildpath)/compiled -DCMAKE_BUILD_TYPE=MinSizeRel \
	&& make -j${PROC_COUNT} \
	&& make install
